...
TILESIZE = 100
BASICFONTSIZE = 20
XMARGIN = int((WINDOWWIDTH - (TILESIZE * BOARDWIDTH + (BOARDWIDTH - 1))) / 2)-130
...
def main():
    ...
    # Opções de ação
    RESET_SURF[0], RESET_RECT[0] = makeText('Novo jogo com 3 mov',   TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 290, WINDOWHEIGHT - 395)
    RESET_SURF[1], RESET_RECT[1] = makeText('Novo jogo com 6 mov',   TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 290, WINDOWHEIGHT - 365)
    RESET_SURF[2], RESET_RECT[2] = makeText('Novo jogo com 9 mov',   TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 290, WINDOWHEIGHT - 335)
    RESET_SURF[3], RESET_RECT[3] = makeText('Novo jogo com 12 mov',  TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 290, WINDOWHEIGHT - 305)
    SOLVE_SURF_1, SOLVE_RECT = makeText('Reverter tudo',             TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 290, WINDOWHEIGHT - 165)
    SOLVE_SURF_2, SOLVE_H = makeText('Resolver em menos de 1mim',    TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 290, WINDOWHEIGHT - 135)
    SOLVE_SURF_3, SOLVE_BFS = makeText('Resolver do melhor jeito',   TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 290, WINDOWHEIGHT - 105)
